...
use SousedskaPomoc\Connectors\TwilioApi;
...
class HeadquartersPresenter extends BasePresenter
{
    ...
    /** @var DemandRepository @inject */
    public $demandRepository;

    /** @var VolunteerRepository @inject */
    public $volunteerRepository;

    /** @var AddressRepository @inject */
    public $addressRepository;

    /** @var CallRouletteRepository @inject */
    public $callRouletteRepository;

    /** @var TwilioApi @inject */
    public $twilioApi;

    /** @var ConferenceCallBot @inject */
    public $callBot;
    ...
    {
        $callRoullete = new CallRoulette();
        $topics = $callRoullete->getTopics();
        ...
        $form->addSelect('callTopicId', "Téma hovoru", $topics);
    ...
    public function startConferenceCall(BootstrapForm $form)
    {
        ...
        $this->twilioApi->setupConfCall($callers, $values->title);
    ...
    public function renderCallsWaiting()
    {
        $this->template->waiting = $this->callRouletteRepository->findBy(['paired' => 0]);
    }

    public function renderManualPairing()
    {
        $callsCount = $this->callBot->connectCallers(
